        ...
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                <a href="index" class="logo logo-dark">
                    <span class="logo-sm">
                        <img src="{{ URL::asset ('/assets/images/coficab1.png') }}" alt="" height="22">
                    </span>
                    <span class="logo-lg">
                        <img src="{{ URL::asset ('/assets/images/coficab1.png') }}" alt="" height="17">
                    </span>
                </a>
                ...
                <a href="index" class="logo logo-light">
                    ...
                    <span class="logo-lg">
                        <img src="{{ URL::asset ('/assets/images/coficab1.png') }}" alt="" height="19">
                    </span>
                </a>
            </div>
